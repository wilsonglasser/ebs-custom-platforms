...
if [ -f /etc/logrotate.d/php-fpm-7.3 ]
then
    /opt/elasticbeanstalk/bin/log-conf -n'php-fpm' -l'/var/log/php-fpm/7.3/*log' -f /opt/elasticbeanstalk/support/conf/php-fpm.logrotate.conf
    rm -f /etc/logrotate.d/php-fpm-7.3
fi
